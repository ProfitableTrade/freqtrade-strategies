...
class Strategy_Goal_Vidra_INJ_EMA_15(IStrategy):
    """
    Strategy_Goal_Vidra_INJ_EMA_15
    ...
    stage_2_sell_amount = 0.4

    # Step buying (DCA) settings
    dca_levels = [-0.02, -0.035]  # Рівні цінового падіння для DCA
    dca_buy_amounts = [0.5, 0.5]  # Відповідні обсяги покупок (50%, 50%)

...
class Strategy_Goal_Depth_INJ(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        volume_value = (dataframe['volume'][:self.settings.depth] > dataframe['volume'][:self.settings.depth].shift(1))
        close_value = (dataframe['close'][:self.settings.depth]  < dataframe['close'][:self.settings.depth].shift(1))
